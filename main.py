...
#     light_theme = Button(tuple(c["colour"]["light"]["2048"]), 200 - 70, 275, 45, 45, "light")
#     # create dark theme button
#     dark_theme = Button(tuple(c["colour"]["dark"]["2048"]), 270 - 70, 275, 45, 45, "dark")
#
#     # initialise theme
#     theme = ""
...
#     _1024 = Button(tuple(c["colour"]["light"]["2048"]), 200, 330, 45, 45, "1024")
...
#
#     # create play button
#     play = Button(tuple(c["colour"]["light"]["2048"]), 235, 400, 45, 45, "play")
#
